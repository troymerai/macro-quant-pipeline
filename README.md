...
07:00 [Part A 시작] GitHub Actions 스케줄러 가동. 관리자 텔레그램 봇으로 시작 알림 전송. 파이썬이 data_sources.json을 기반으로 시장 데이터 수집 시작.
...
0. Infrastructure
Config-Driven: data_sources.json에 출처별 신뢰도(Trust Level) 가중치를 부여하여 코드 수정 없이 데이터 소스 관리.
